...
namespace InventoryManagement.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        public ActionResult GetAllProductNames( string ProdFor, bool forFrOrder, bool forDrOrder)
        {
            ...
            List<string> model = objTransacManager.GetAutocompleteProductNames(RestrictedproductsAlso,  ProdFor,  forFrOrder,  forDrOrder);
            return Json(model, JsonRequestBehavior.AllowGet);
        }
        
        public ActionResult GetProductNamesOnly( string ProdFor, bool forFrOrder, bool forDrOrder)
        {
            List<string> model = objTransacManager.GetAutocompProductsOnly(false,  ProdFor,  forFrOrder,  forDrOrder);
            return Json(model, JsonRequestBehavior.AllowGet);
        }
